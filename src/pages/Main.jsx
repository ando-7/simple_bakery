  ...
  return (
    <Box
      ...
      <Box
        ...
        <Button variant='contained' size='large' color='warning' href='/about'>
          About Us
        </Button>
        <Button
          variant='contained'
      ...
      <Box
        ...
        <Box sx={iconBoxStyle}>
          ...
          <Typography sx={iconDescriptionStyle}>
            Friendly local farms
          </Typography>
        </Box>
